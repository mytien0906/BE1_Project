...
?>
        ...
        <div class="detail" style="padding-top:10px">
            <div class="row">
                <div class="col-md-5">
                    <img style="height:340px" class="img-responsive" src="public/image/<?php echo $value_detail['image'] ?>" alt="">
                </div>
                <div class="col-md-7">
                    ...
                    <form action="cart.php?id_product=<?php echo $value_detail['id'] ?>" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <br><input type="number" value="1" min="1" class="form-control" name="qty">
                            </div> <br>
