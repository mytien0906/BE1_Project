        ...
        <center>
            <div aria-label="Page navigation">
                <ul class="pagination">
                    ...
                    <li>
                        <a aria-label="Previous" href="?page=<?php if ($page <= 1) echo 1;
                                                                else echo $page - 1 ?>">
                            <span aria-hidden="true">←</span>
                        </a>
                    </li>
                    ...
                    <?php } ?>
                    <li>
                        <a aria-label="Previous" href="?page=<?php if ($page >= $num) echo $num;
                                                                else echo $page + 1 ?>">
                            <span aria-hidden="true">→</span>
                        </a>
                    </li>
...
<?php
    ...
    public function AddProduct($name_product, $price_product, $img, $price_sale, $desc_product, $manu_product, $cate_product)
    {
        $sql = self::$connection->prepare("INSERT INTO products(`name`, `price`, `image`, `description`, `sale`, `manu_id`, `cate_id`) 
            VALUES('$name_product','$price_product','$img','$desc_product','$price_sale','$manu_product','$cate_product')");
  ...
  public function updateProductById($id, $img, $size_img, $name_product, $price_product, $price_sale, $desc_product, $manu_product, $cate_product)
    {
        if ($size_img == 0) {
            ...
            $sql = self::$connection->prepare("UPDATE products SET name='$name_product',price='$price_product',description='$desc_product',sale='$price_sale'
