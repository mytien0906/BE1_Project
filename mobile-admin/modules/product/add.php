...
if (isset($_POST['add_product']) && isset($_POST['name_product']) && isset($_POST['price_product']) && isset($_POST['desc_product']) ) {
    ...
    $img1 = $photo =($_FILES['img_product']['name']);
    ...
    $folderPath = 'C:/wamp64/www/BE_MyTien/public/image/' . basename($_FILES['img_product']['name']);
    if (isset($img1)) {
        move_uploaded_file($_FILES['img_product']['name'], $folderPath);
        $product = new Product();
        $product->AddProduct($name1,$price1,$img1,$sale1,$desc1,$manu_id1,$cate_id1);
    }
}
    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="http://localhost/BE_MyTien/mobile-admin/modules/product/add.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-9">
